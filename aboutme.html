...
<div class='profile-card__name'> Đỗ Xuân Bách <i class='fa fa-check-circle' style='color:rgb(17, 143, 249)' title='Verified Author'></i>
</div>
<div class='profile-card__txt'>Tôi là <b>Xuân Bách</b>, một cậu sinh học sinh cấp 1 mới lên cấp 2 yeye </b> với ước mơ trở thành một Developer chuyên cmn nghiệp. Biết đôi chút về <i>Python, php, scracth</i> ...</div>
<div class='profile-card-loc'>
<span class='profile-card-loc__icon'>
<svg class='icon'><use xlink:href='#icon-location'></use></svg>
</span>
<span class='profile-card-loc__txt'>Hưng Yên</span>
</div>
<div class='profile-card-inf'>
<div class='profile-card-inf__item'>
<div class='profile-card-inf__title' id='count-followers'>498</div>
